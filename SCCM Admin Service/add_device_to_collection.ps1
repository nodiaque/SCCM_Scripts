<#	
	...
	===========================================================================
	 ...
	 Organization: 	
	 Filename: 		add_device_to_collection.ps1    	
	===========================================================================
	.DESCRIPTION
		Add the device to the collection using SCCM adminservice
#>
[cmdletbinding()]
param (
...
<#
	.SYNOPSIS
		Create PSCredential object using the script username and password
	
	.DESCRIPTION
		
	
	.EXAMPLE
				PS C:\> Get-AuthCredential
...
<#
	.SYNOPSIS
		Create a SCCM Direct Membership Rules
	
	.DESCRIPTION
		A detailed description of the New-CMDirectRule function.
	
	.PARAMETER InputObject
		A description of the InputObject parameter.
	
	.PARAMETER ResourceId
		A description of the ResourceId parameter.
	
	.PARAMETER RuleName
		A description of the RuleName parameter.
	
	.PARAMETER Type
		A description of the Type parameter.
	
	.EXAMPLE
				PS C:\> New-CMDirectRule -InputObject $value1
...
<#
	.SYNOPSIS
		Initate output logging
	
	.DESCRIPTION
		User Start-transcript to log everything into a log file
	
	.PARAMETER scriptname
		Used to name the log output
...
<#
	...
	.DESCRIPTION
		A detailed description of the Stop-Logging function.
...
<#
	...
	.DESCRIPTION
		A detailed description of the writeLog function.
	
	.PARAMETER text
		A description of the text parameter.
	
	.EXAMPLE
				PS C:\> writeLog -text 'Value1'
...
writeLog -text "Ajout de $device dans la collection $collectionid"
...
$URIADD = "https://$sccmsite/AdminService/wmi/SMS_Collection(`'$collectionID`')/AdminService.AddMembershipRule"
$Result = foreach ($Rule in $CollectionRule)
{
	...
	try
	{
		...
		[string]$user = whoami
		$DateNow = "[{0:yyyy/MM/dd} {0:HH:mm:ss}]" -f (Get-Date) + "[$user]"
		Write-Host "$($DateNow)> Device $device is not in collection $collectionID"
...
if ($Result.returnvalue -eq 0)
{
	...
	writeLog -text "Success"
	$ERRORCODE = $Result.returnvalue
}
else
{
	writeLog -text "Fail"
	writeLog -text "Does the collection exist?"
	$ERRORCODE = "-1"
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCClQ7AfyfVqhsxO
# sv/sb1VB46CJprlU+Nzk8AkE0yvak6CCJQ8wggU9MIIEJaADAgECAhAG4KIaKzBS
...
# AKBMMBkGCSqGSIb3DQEJAzEMBgorBgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBs
# TmKJIenxfE4ic2AfXkQqC3oSMaSFhAlrMtgNj5vF2jANBgkqhkiG9w0BAQEFAASC
# AQB8FI8FrNFTK6FEL6QW4VucypIk806UhXC7dMO9Rs0ET5+rKzKUnNhPMq5DSumJ
# BeAexI9GJNcjxTfMHs9Kp+vptnjkLQqqwF28FVSnoLPnPSD8x/hmsXep7a1qK/zw
# HfHd3HP/1U/RVmEXHn3+bg5ULXYwbZmoZ1H4IsI3VoM2yMrBACLxiHxvk14wPQvB
# EN+KeAC9C5A/RiAphn/sGPVSLsKNn+GCn7gKpmnEGneIxWNxxiqVt6ebrUPShkiB
# fzh2RdG+TMlfawvfFbXHc7Glqo+SDZ3Zv/8TPkT+MXZvoDM1pHzHjpaXmEkHZbT+
# jHnLAzFQ1me0khWkpJW5MX0voYIDbDCCA2gGCSqGSIb3DQEJBjGCA1kwggNVAgEB
...
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yNDAyMDIxMzI4NDlaMCsGCSqG
# SIb3DQEJNDEeMBwwCwYJYIZIAWUDBAIBoQ0GCSqGSIb3DQEBCwUAMC8GCSqGSIb3
# DQEJBDEiBCB2M2S7PTM70AJ9mOZunpMI2cnutUkycNoJCKr/VP/8VDCBpAYLKoZI
...
# SJA9woq8p6EZTQwcV7gpMA0GCSqGSIb3DQEBCwUABIIBgF/jvGek5TgbdrbhMChe
# ekTyPzmYxFf+KxWu8iw/IxJ0fxBEiuL0PT7iDquS0SCTzqxi7YJXA4tDpOk9aKd3
# Qm5rSa1cEnOLqnZ9Gy9pulCoq3q1+3X59rOoaRHY92WqFX76ib8jxpyW1075KA0j
# FjfYVwc1wJHQkYgVVhpmKy5tB2bWuHbNQIMo0AroGlPozX1C6IZiAvqZgrVXb1IP
# aEcLCCtZPO0EFhW89hLCr4T28x31WQyylVizrATuWR2lFum0z+IrtM/trVBj6ZXL
# kOo6Ctn8Qp+9/X97ZzkZtIOrHb8m5gw6sqtWYJSGTW3C8/YM0azjPpVtG/CVyuio
# EytWyjsyJRWvC12538A0PaN9znjCuo2x0RePe05MxlekFihafAD+aW2aiQd49WHL
# r8dSgbDfc1BgwYlffH9nVQbT2u3dh1xBhA9T+kcHsks+9AUxWi8bCsmoEZNqJZlZ
# UTJkqZuCk553RY42VE+/enTSypjGa7NaPx2Ag4oAwOAJDg==
