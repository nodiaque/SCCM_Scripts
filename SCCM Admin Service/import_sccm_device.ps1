<#
	.SYNOPSIS
		Import netbiosname in SCCM
	
	.DESCRIPTION
		Import netbiosname in SCCM using the rest api
		Require either MacAddress or SMBIOSGUID to be set
		Todo
		- Add a way to do it from CMG
	
	.PARAMETER netbiosname
		The name of the netbiosname to import
	...
	.PARAMETER MACAddress
		A description of the MACAddress parameter.
	
	.PARAMETER SMBIOSGUID
		A description of the SMBIOSGUID parameter.
	...
	.NOTES
		...
		Organization:
		Filename:     	import_sccm_device.ps1
		===========================================================================
#>
param
(
...
$scriptName = $scriptName + "-" + $netbiosname
$credential = ""
...
try
{
	...
	if ([string]::IsNullOrEmpty($MACAddress) -and [string]::IsNullOrEmpty($SMBIOSGUID))
	{
		Write-CMLogEntry -Value "No MACAddress or SMSBIOSGUID, cannot continue" -Severity 3
	...
	$URI = "https://$endpoint/AdminService/wmi/SMS_Site.ImportMachineEntry"
	$body = @{
	...
	try
	{
		...
		Write-CMLogEntry -Value "Unable to import device $netbiosname, insuffisant permission" -Severity 3
		Write-CMLogEntry -Value "Exit code: 1" -Severity 3
		Stop-Logging
		[System.Environment]::Exit(1)
	}
	...
	{
		Write-CMLogEntry -Value "Error during device import!" -Severity "3"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBAUDKvV64VeGC1
# UgtIInehOh5NMadsWxxO9bpcP8sWxKCCJXwwggU9MIIEJaADAgECAhAG4KIaKzBS
...
# NwIBBDAvBgkqhkiG9w0BCQQxIgQg4ZbZKa/x1Kf5Vl9AhQ0/EOJLTyU+yg8mcW+I
# PnI5seAwDQYJKoZIhvcNAQEBBQAEggEAQQRZdDMCss/laeNSV1Wif8XYIbSIUndK
# oe2oEX3K3qeIbRhvz7iAQ5f9EmMCY4AjKsenQb4RoUcM+1upmENQ3JAEoYJApNCK
# oyyeQa1W44aNxiAM380Z/WvipKB4AOIVfHt0KghuHBH2nzD2XK7o7UFIgiSWDnpz
# 3h06TLC74sAMIUaiGaWGSI7Lz7E34WSBR5n0q7De/gXWmTFr/WxgJgQtHHz+Rrk4
# +V62SVdnLQD9OtPAnVDA+KpxqrIuzRo83AWuLvmBfYMwcP6+9HMlxCIjKCkGLUOe
# w6STsLNL1rRQU9rJLQpElSjNS/jQa4bseqO96HHwpWKRihXs7vkQbKGCA2wwggNo
...
# DxcNMjQwNDEyMTQyNDM4WjArBgkqhkiG9w0BCTQxHjAcMAsGCWCGSAFlAwQCAaEN
# BgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgkpgAxews7WNqKfmDC3NrvUUd
# GohrjREy/ik5JbumkhowgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGOMIGLBBRE05Oc
...
# AQsFAASCAYBQT8xp4TIolNh9RDuCRjKZ1IHnILHTiBSm5sCWGWz1HWU/qa/7VUfp
# FW5wwbQRuV+pjK/t9J+jB8CWJ8LpX+Gon+8T7rOhKXEGa0eXGRIfEr0AIio4SftL
# ypCdq0YpoqJfkUYe+kiUKXPjn+U5K4ii1ED6mNEs6RE0q18hWL4YXqKIxys6Rl78
# JUWK4iG+wREyWTsfk8obKq1UJ6y3AcfgwTlbJIxIFnynzk4z4sCmfzP3/k9GQRs2
# uH6YywzMyrO5SF0a3m2h19qPMVtzEbpS6AW70WsXCiX3pep9PiOEY84PKt1RjMnG
# lSKKb2CjcFZwPonXlV5tVfT+9djkrgLMTNSWdU9b60O4L7d3ASUgstdDeiFyBAcs
# 3MJbtqP7XudAtlh3ZFBTz82pz0RJoKCEfQ7S8qMouil5RFCvfb5lXLJM8qGu2n33
# J8g0kXrG7UWzFtK00eLY/bThH4cYRMWZ/QYcvhI1l1DSMgSOslKlZAlVDUX1Nrq8
# m7KxFhoxxLY=
